...
def main():
    ...
    train_dataset = IMCPSymbolDatasetV3('train_v4.jsonl', tokenizer)
    val_dataset = IMCPSymbolDatasetV3('val_v4.jsonl', tokenizer)
    ...
    torch.save(model.state_dict(), 'final_model_v4.pt')
    print("✓ Saved final_model_v4.pt")
